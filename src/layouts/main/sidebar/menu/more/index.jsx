  ...
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
        ...
        <Disclosure>
          <Disclosure.Button
            className="h-[52px] flex items-center justify-between w-full px-4 hover:bg-[#eff3f41a] transition-colors"
          >
          ...
          <Disclosure.Panel className="text-gray-500">
            <Link to="/"
              className="flex items-center px-3 h-11 gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors text-white">
        ...
        <Disclosure>
          ...
          <Disclosure.Panel className="text-gray-500">
            ...
            <button
              className="flex items-center px-3 h-11 w-full gap-3 font-medium hover:bg-[color:var(--background-secondary)] transition-colors text-white"
            >
              <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                <path
                  fill="currentColor"
